...
void Text::create(const std::string& text, int32_t fontId, const Color& color, const Point& pos) {
    ...
    gResourceManager->createText(text, color, fontId, _drawParams.rsrcId, _drawParams.width, _drawParams.height);
...
void Text::setText(const std::string& text) {
    ...
    _textContent = text;
    gResourceManager->createText(text, _color, _fontId, _drawParams.rsrcId, _drawParams.width, _drawParams.height);
...
void Text::setColor(const Color& color) {
    ...
    _color = color;
    gResourceManager->createText(_textContent, color, _fontId, _drawParams.rsrcId, _drawParams.width, _drawParams.height);
}
